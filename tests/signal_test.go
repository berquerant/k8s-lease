...
func TestSignal(t *testing.T) {
	...
	t.Run("testbin", func(t *testing.T) { testSignalTestbin(t, bin) })
	t.Run("exit", func(t *testing.T) { testSignalExit(t, bin) })
	t.Run("cancel", func(t *testing.T) { testSignalCancel(t, bin) })
}

func testSignalTestbin(t *testing.T, bin string) {
...
func testSignalExit(t *testing.T, bin string) {
...
func testSignalCancel(t *testing.T, bin string) {
